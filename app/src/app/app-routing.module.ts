...
import { DevelComponent } from './dashbord/GestConDev/devel/devel.component';
import { GestionDeveloppementComponent } from './dashbord/GestConDev/gestion-developpement/gestion-developpement.component';
...
const routes: Routes = [
 ...
 {path:'',component:TopbarComponent,children: [
  ...
  {path:'GCD',component:GestConDevComponent,children:[
    {path:'gestion-developpement',component:GestionDeveloppementComponent},
    {path:'gestion-developpeur',component:DevelComponent},
